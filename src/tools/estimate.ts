...
export const estimateSchema = z.object({
  ...
  formats: z
    ...
    .optional()
    .describe(
      "Output formats to include in the estimate. Passed to the API but does not currently affect the cost estimate — the endpoint uses URL-pattern heuristics only. " +
